...
Десктопный **real-time дата-логгер в классическом облике MoTeC i2 Pro**:
серый Windows-хром с меню/тулбаром/статус-баром, чисто чёрные графики с
тонкими насыщенными трассами (красный/жёлтый/зелёный/циан/маджента), белые
списки, worksheet-вкладки снизу. Прокручивающиеся каналы с курсором, приборы,
...
| **КРУГИ / ДЕЛЬТА** | фирменный i2-анализ: наложение кругов **по дистанции**, Δ-время к эталону (variance), эталон = лучший круг (★), текущий круг рисуется live, курсор с readout эталон/live; live-дельта также питает канал Δ BEST на дашборде |
| **ГИСТОГРАММЫ** | i2 Histogram: распределение времени сессии по газу, тормозу, скорости и передачам (в % времени, со средними) |
| **Маркеры кругов** | вертикальные линии L2, L3… на границах кругов на всех дорожках графика |
| **Карта по скорости** | контур трассы окрашен по скорости: синий → зелёный → жёлтый → красный (classic i2 speed map) |
...
sources/
  ...
  laps.py               LapStore — круги на дистанционной сетке + live-дельта
...
ui/
  ...
  lapcompare.py         вкладка «КРУГИ / ДЕЛЬТА» (наложение кругов, variance)
